...
def main():
    ...
    print(f"  {'─' * 40}")
    print(f"  UI 页面:   http://127.0.0.1:8765")
    print(f"  Mock 桥:   http://127.0.0.1:8765/run")
    print(f"  健康检查:  http://127.0.0.1:8765/health")
    print(f"  Demo 图:   http://127.0.0.1:8765/demo-image.png  ({DEMO_PNG_HASH})")
